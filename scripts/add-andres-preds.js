...
const andresData = {
  ...
  "betting_scores_extension": [
    ...
    { "matchId": 16, "predicted_home": 2, "predicted_away": 0 },
    ...
    { "matchId": 21, "predicted_home": 4, "predicted_away": 1 },
    ...
    { "matchId": 31, "predicted_home": 4, "predicted_away": 2 },
    { "matchId": 32, "predicted_home": 2, "predicted_away": 1 },
    { "matchId": 33, "predicted_home": 3, "predicted_away": 1 },
    { "matchId": 34, "predicted_home": 2, "predicted_away": 1 },
...
let user = db.users.find(u => u.id === andresData.id);
if (!user) {
  user = {
    id: andresData.id,
...
// Map predictions from Andres's payload
andresData.betting_scores_extension.forEach(pred => {
...
// Run point recalculation for all users (including Andres)
db.users.forEach(u => {
  let userTotal = 0;
...
console.log('Successfully added ANDRES predictions and recalculated standings.');
