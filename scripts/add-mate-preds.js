...
const mateData = {
  ...
  "betting_scores_extension": [
    ...
    { "matchId": 20, "predicted_home": 1, "predicted_away": 0 },
    { "matchId": 21, "predicted_home": 2, "predicted_away": 0 },
    { "matchId": 22, "predicted_home": 1, "predicted_away": 1 },
    { "matchId": 23, "predicted_home": 0, "predicted_away": 1 },
    { "matchId": 24, "predicted_home": 0, "predicted_away": 2 },
    { "matchId": 25, "predicted_home": 0, "predicted_away": 1 },
    { "matchId": 26, "predicted_home": 1, "predicted_away": 0 },
    ...
    { "matchId": 30, "predicted_home": 0, "predicted_away": 3 },
    { "matchId": 31, "predicted_home": 3, "predicted_away": 0 },
    { "matchId": 32, "predicted_home": 1, "predicted_away": 1 },
    { "matchId": 33, "predicted_home": 1, "predicted_away": 0 },
    { "matchId": 34, "predicted_home": 2, "predicted_away": 0 },
    { "matchId": 35, "predicted_home": 1, "predicted_away": 0 },
...
let user = db.users.find(u => u.id === mateData.id);
if (!user) {
  user = {
    id: mateData.id,
    name: mateData.name,
...
// Map predictions from Mate's payload
mateData.betting_scores_extension.forEach(pred => {
...
// Run point recalculation for all users (including Mate)
db.users.forEach(u => {
  let userTotal = 0;
...
console.log('Successfully added MATE predictions and recalculated standings.');
