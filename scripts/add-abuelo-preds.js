...
const abueloData = {
  ...
  "betting_scores_extension": [
    { "matchId": 13, "predicted_home": 4, "predicted_away": 0 },
    { "matchId": 14, "predicted_home": 3, "predicted_away": 1 },
    { "matchId": 15, "predicted_home": 2, "predicted_away": 3 },
    { "matchId": 16, "predicted_home": 2, "predicted_away": 1 },
    { "matchId": 17, "predicted_home": 3, "predicted_away": 1 },
    { "matchId": 18, "predicted_home": 1, "predicted_away": 1 },
    { "matchId": 19, "predicted_home": 3, "predicted_away": 0 },
    { "matchId": 20, "predicted_home": 2, "predicted_away": 1 },
    { "matchId": 21, "predicted_home": 3, "predicted_away": 1 },
    { "matchId": 22, "predicted_home": 2, "predicted_away": 2 },
    { "matchId": 23, "predicted_home": 3, "predicted_away": 1 },
    { "matchId": 24, "predicted_home": 1, "predicted_away": 2 },
    { "matchId": 25, "predicted_home": 1, "predicted_away": 1 },
    { "matchId": 26, "predicted_home": 2, "predicted_away": 2 },
    { "matchId": 27, "predicted_home": 2, "predicted_away": 1 },
    { "matchId": 28, "predicted_home": 1, "predicted_away": 2 },
    { "matchId": 29, "predicted_home": 3, "predicted_away": 0 },
    { "matchId": 30, "predicted_home": 1, "predicted_away": 2 },
    { "matchId": 31, "predicted_home": 4, "predicted_away": 0 },
    { "matchId": 32, "predicted_home": 1, "predicted_away": 2 },
    { "matchId": 33, "predicted_home": 2, "predicted_away": 2 },
    { "matchId": 34, "predicted_home": 2, "predicted_away": 2 },
    { "matchId": 35, "predicted_home": 3, "predicted_away": 0 },
    { "matchId": 36, "predicted_home": 1, "predicted_away": 3 }
  ]
};
...
let user = db.users.find(u => u.id === abueloData.id);
if (!user) {
  user = {
    id: abueloData.id,
    name: abueloData.name,
    total_points: 0,
    betting_scores: []
  };
  db.users.push(user);
...
// Map predictions from Abuelo's payload
abueloData.betting_scores_extension.forEach(pred => {
...
console.log('Successfully added ABUELO predictions and recalculated standings.');
