...
const matiData = {
  ...
  "betting_scores_extension": [
    ...
    { "matchId": 16, "predicted_home": 1, "predicted_away": 1 },
    ...
    { "matchId": 20, "predicted_home": 2, "predicted_away": 0 },
    { "matchId": 21, "predicted_home": 2, "predicted_away": 0 },
    { "matchId": 22, "predicted_home": 1, "predicted_away": 1 },
    ...
    { "matchId": 26, "predicted_home": 2, "predicted_away": 0 },
    ...
    { "matchId": 30, "predicted_home": 1, "predicted_away": 1 },
    { "matchId": 31, "predicted_home": 2, "predicted_away": 1 },
    { "matchId": 32, "predicted_home": 1, "predicted_away": 1 },
    { "matchId": 33, "predicted_home": 2, "predicted_away": 1 },
    { "matchId": 34, "predicted_home": 4, "predicted_away": 1 },
    { "matchId": 35, "predicted_home": 1, "predicted_away": 1 },
...
let user = db.users.find(u => u.id === matiData.id);
if (!user) {
  user = {
    id: matiData.id,
    name: matiData.name,
...
// Map predictions from Mati's payload
matiData.betting_scores_extension.forEach(pred => {
...
// Run point recalculation for all users (including Mati)
db.users.forEach(u => {
  let userTotal = 0;
...
console.log('Successfully added MATI predictions and recalculated standings.');
